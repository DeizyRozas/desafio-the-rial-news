...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference("comentario.count") do
      post comentarios_url, params: { comentario: { contenido: @comentario.contenido, noticia_id: @comentario.noticia_id, usuario_id: @comentario.usuario_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { contenido: @comentario.contenido, noticia_id: @comentario.noticia_id, usuario_id: @comentario.usuario_id } }
