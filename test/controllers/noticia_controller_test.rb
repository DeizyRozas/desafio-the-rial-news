...
class NoticiaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticium" do
    assert_difference("Noticium.count") do
      post noticia_url, params: { noticium: { cuerpo: @noticium.cuerpo, encabezado: @noticium.encabezado, titulo: @noticium.titulo } }
    end
  ...
  test "should update noticium" do
    patch noticium_url(@noticium), params: { noticium: { cuerpo: @noticium.cuerpo, encabezado: @noticium.encabezado, titulo: @noticium.titulo } }
